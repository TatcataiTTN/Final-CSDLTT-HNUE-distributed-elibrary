...
$LOCATIONS   = ["Hồ Chí Minh"]; // ✔ Chi nhánh HN chỉ có Hà Nội
$STATUS_LIST = [
    'active'       => 'Hoạt động',
...
$currentLoc    = $isEditing ? ($editingBook['location'] ?? 'Hồ Chí Minh') : 'Hồ Chí Minh';
?>
<!DOCTYPE html>
<html lang="vi">
<head>
...
<div class="page-overlay">
    <div class="container">
        ...
        <h2>📚 Quản lý sách - Chi nhánh Hồ Chí Minh</h2>
        ...
        <div class="form-wrapper">
            ...
            <?php else: ?>
                ...
                <p style="color:#555; margin-top:4px;">
                    ...
                    Tại chi nhánh Hồ Chí Minh chỉ được phép điều chỉnh <b>số lượng tồn</b> và <b>trạng thái</b>.
                </p>
            <?php endif; ?>
        </div>
