...
if (isset($_GET['add'])) {
    ...
    try {
        ...
        if ($book) {
            ...
            $_SESSION['cart_message'] = "⚠ Sách không tồn tại hoặc không thuộc chi nhánh Hồ Chí Minh.";
        }
    } catch (Exception $e) {
...
<head>
    <meta charset="UTF-8">
    <title>Danh sách sách - Chi nhánh Hồ Chí Minh</title>
...
<div class="page-overlay">
    <div class="container">
        ...
        <h2>📚 Danh sách sách - Chi nhánh Hồ Chí Minh</h2>
        ...
        <div class="table-wrapper">
            <h3>Tất cả sách đang có tại Chi nhánh Hồ Chí Minh</h3>
            <table>
                <thead>
                <tr>
                    <th>BookCode</th>
