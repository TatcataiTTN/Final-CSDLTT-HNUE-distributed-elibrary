<?php
// =============================================================================
// API: Receive Books from Central Hub - Branch (Ho Chi Minh)
// =============================================================================
// Requires JWT authentication with admin role
// =============================================================================

require_once "../connection.php"; // Kết nối MongoDB CHI NHÁNH HỒ CHÍ MINH
...
foreach ($data as $b) {
    ...
    $update = [
        '$set' => [
            ...
            'bookGroup'   => $bookGroup,
            'bookName'    => $bookName,
            'location'    => 'Hồ Chí Minh',      // ép đúng chi nhánh Đà Nẵng
