...
// =============================================================================
// MongoDB Connection Configuration - BRANCH (NhasachDaNang)
// =============================================================================
// Mode:
...
$Database = "NhasachDaNang"; // Da Nang Branch Database
...
try {
    switch ($MODE) {
        ...
        case 'replicaset':
            // Replica Set Connection - DaNang is SECONDARY in rs0
        ...
        default:
            // Standalone Connection - Da Nang Branch on port 27019
            $Servername = "mongodb://localhost:27019";
            $conn = new Client($Servername);
            break;
    }
