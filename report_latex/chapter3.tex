...
\textbf{Đồng bộ dữ liệu thủ công:} Cơ chế đồng bộ dữ liệu giữa Central Hub và các chi nhánh hiện vẫn yêu cầu quản trị viên kích hoạt thủ công. Chưa có giải pháp đồng bộ thời gian thực (real-time synchronization) hoặc xử lý xung đột dữ liệu (conflict resolution) khi cùng một bản ghi được cập nhật đồng thời tại nhiều nơi.
