...
% PHỤ LỤC A
% ============================================================================
\chapter{PHỤ LỤC A: TÀI LIỆU KỸ THUẬT}
...
% PHỤ LỤC B
% ============================================================================
\chapter{PHỤ LỤC B: THÔNG TIN LIÊN HỆ VÀ MÃ NGUỒN}
...
% PHỤ LỤC C
% ============================================================================
\chapter{PHỤ LỤC C: TỰ ĐÁNH GIÁ THEO RUBRIC}
...
\begin{tabular}{|c|p{6.5cm}|c|c|p{4.5cm}|}
\hline
\textbf{STT} & \textbf{Tiêu chí} & \textbf{Tối đa} & \textbf{Điểm} & \textbf{Ghi chú} \\
\hline
\multicolumn{5}{|c|}{\textbf{PHẦN NHÓM TỰ ĐÁNH GIÁ (90 điểm)}} \\
\hline
...
\hline
\multicolumn{2}{|r|}{\textbf{Tổng điểm nhóm tự chấm}} & \textbf{90} & \textbf{86} & \\
\hline
\multicolumn{5}{|c|}{\textbf{PHẦN GIẢNG VIÊN ĐÁNH GIÁ (10 điểm)}} \\
\hline
7 & Báo cáo cuối kỳ (PDF) (đầy đủ nội dung, hình ảnh, code, định dạng) & 5 & & \textit{GV chấm} \\
\hline
8 & Demo và trả lời vấn đáp (demo chức năng, trả lời câu hỏi) & 5 & & \textit{GV chấm} \\
\hline
\multicolumn{2}{|r|}{\textbf{Tổng điểm GV chấm}} & \textbf{10} & & \\
\hline
\multicolumn{2}{|r|}{\textbf{TỔNG ĐIỂM TOÀN BỘ}} & \textbf{100} & \textbf{86 + ?} & \\
\hline
\end{tabular}
\end{table}
...
\subsubsection{Tiêu chí 1: Thiết kế mô hình CSDL NoSQL (20/20)}
...
\subsubsection{Tiêu chí 2: Triển khai hệ thống CSDL phân tán (18/20)}
...
\subsubsection{Tiêu chí 4: Xử lý truy vấn và tính toán nâng cao (14/15)}
...
\subsubsection{Tiêu chí 6: Hiệu năng và đánh giá hệ thống (10/10)}
...
\begin{itemize}
    ...
    \item Phân tích ưu/nhược điểm của mô hình phân tán
\end{itemize}
